...
from ..function_utils.create_function import simple_dynamic_initializer
...
class field:
	...
	#Note that (internally) this way of doing things should be reserved for pre-rts types
