...
#This experiment will load a larger dataset to see a bit how memory is impacted by this
...
class extended_source_information(file_information, source_information):
	#BUG - if this RTS.initializer is defined in file_information it never gets called!
	@RTS.initializer
	def load_source(self):
...
cr = code_registry.from_path('/home/devilholk/Projects')
