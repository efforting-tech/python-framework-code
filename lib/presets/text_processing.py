...
from ..symbols import register_symbol, create_symbol, register_multiple_symbols, symbol_node
...
from ..type_system.representation import adjust_field_stack_limit
