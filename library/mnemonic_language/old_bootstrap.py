...
#PLAN - The definition/registration of a mnemonic pattern should be separate from the implementation so that we can switch between a regex based system and the token based system
