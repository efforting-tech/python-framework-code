...
define_record('positional', named=dict(
	default=None,
	factory=None,
), bases=(Abstract_Record, ABC.Record.Member,))
...
define_record('all_named', bases=(Abstract_Record, ABC.Record.Member,))
define_record('all_positional', bases=(Abstract_Record, ABC.Record.Member,))
